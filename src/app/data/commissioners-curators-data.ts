...
export const CURATORS: Curator[] = [
    ...
    },
    {
        ...
        text: "Jason is co-founder and director of TakahashiLim A + D, a Singapore-based design consultancy that leverages cutting edge technology to create new spatial experiences, with projects encompassing art, interiors and interaction design. He received his doctorate from ETH Zurich, completing a dissertation on robotic programming in the context of architectural education at GramazioKohler Research. Jason also graduated with a Bachelor of Architecture degree from Cornell University and was awarded the AIA Henry Adams Merit Prize. He also also holds a Master of Engineering from the Stevens Institute of Technology.\n\nJason is an educator with extensive teaching experience at international universities. He is currently an adjunct Assistant Professor of Architecture and Sustainable Design at the Singapore University of Technology and Design (SUTD), where he focuses on design computation. Furthermore he has taught architecture, art and engineering students at the National University of Singapore (NUS), as well as Parsons the New School for Design and Stevens Institute of Technology in the United States. "

    },
    {
        name: "Tomohisa Miyauchi",
        title: "Curator",
        imageUrl: "/assets/about/tm.jpg",
        text: "Tomohisa Miyauchi is Senior Lecturer at the Department of Architecture, National University of Singapore, conducting design studio and lectures. His teaching and research areas include architectural practice as entrepreneurship and experimentation, contemporary architectural theory, and curation in architecture. He received his Bachelor of Architecture from the Southern California Institute of Architecture (SCI-Arc) in 2000, and Master in Architecture from the Graduate School of Design at Harvard University (GSD) in 2004. He set up an architectural partnership in Tokyo shortly after graduating from SCI-Arc and was responsible for the design of a host of built projects relating to art, furniture, interior and architecture in Japan and China. In 2010, he was selected as one of the 20 emerging designers in “JAPAN DESIGN+” by the Ministry of Economy, Trade, and Industry (METI) of Japan. He was co-curator for the Singapore Pavilion at the 15th International Architecture Exhibition, La Biennale di Venezia, 2016."
    },
    {
        name: "Wu Yen Yen",
        title: "Curator and Exhibition Designer",
